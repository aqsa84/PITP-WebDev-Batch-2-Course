// --- JAVASCRIPT LOGIC ---
        ...
        // 1. creat an array of possible answers (classic + Fun/Sarcastic
        const answers =  [
            "It is certain. ",
            "Yes definitely. " ,
            "Chances are good. ",
       ...
       // 2. Select the important HTML elements
        ...
        // 3. The function that run on click 
